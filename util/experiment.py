...
class Experiment():
    ...
    def __init__(self, run_n=0 ):
        self.run_n = run_n
        self.result_dir = os.path.join(co.config['result_dir'], 'run_' + str(self.run_n))
        self.model_dir = os.path.join(co.config['model_dir'],'run_' + str(self.run_n))
        self.fig_dir = os.path.join(co.config['fig_dir'], 'run_' + str(self.run_n))
    ...
    def setup(self, fig_dir=False, result_dir=False, tensorboard_dir=False, model_dir=False):
        ...
        if tensorboard_dir:
            self.tensorboard_dir = os.path.join(co.config['tensorboard_dir'],'run_' + str(self.run_n))
