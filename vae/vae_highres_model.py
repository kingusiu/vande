...
class VAE_HR(VAE):
	 ...
	 def __init__(self, *args, **kwargs):
        super(VAE_3D,self).__init__(*args, **kwargs)
        self.dense_sz = 128
    ...
    def build_encoder(self, inputs):
        ...
        x = tf.keras.layers.Dense(self.denze_sz, activation='relu',kernel_regularizer=self.regularizer)(x)  # reduce convolution output
    ...
    def build_decoder(self):
        ...
        x = tf.keras.layers.Dense(self.denze_sz, activation='relu',kernel_regularizer=self.regularizer)(latent_inputs)  # inflate to input-shape/200
